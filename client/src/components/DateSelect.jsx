...
relative p-8 bg-primary/10 border border-primary/20 rounded-lg'>
                ...
                <div>
                    ...
                    <div className='flex items-center gap-6 text-sm mt-5'>
                        <ChevronLeftIcon width={28} className='cursor-pointer' onClick={()=>setSelected(dateTime[0])}/>
...
cursor-pointer ${selected === date ? 'bg-primary text-white' : 'border border-primary/70'}` }>
                        ...
                        <ChevronRight width={28} className='cursor-pointer' onClick={()=>setSelected(dateTime[dateTime.length-1])}/>
                    </div>
                </div>
