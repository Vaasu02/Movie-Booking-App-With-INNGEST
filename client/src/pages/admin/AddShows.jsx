    ...
    const handleAddShow=async()=>{
        try {
            ...
            if(!selectedMovie || Object.keys(dateTimeSelection).length === 0 || !showPrice){
                toast.error("Please select a movie and date-time and price");
                setAddingShow(false);
                return;
            }
...
fill-primary" />
                                        T {movie.vote_average.toFixed(1)}
                                    </p>
...
px-3 py-2 rounded-md">
            ...
            <button 
                ...
                disabled={addingShow} 
                className="bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer flex items-center justify-center gap-2"
            >
                {addingShow ? (
                    <>
